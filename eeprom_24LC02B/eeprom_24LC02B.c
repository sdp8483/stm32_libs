...
} // end EEPROM_24LC02B_read_uint16()
...
} // end EEPROM_24LC02B_read_uint32()
...
double EEPROM_24LC02B_read_double(uint8_t data_addr) {
	...
	return data.val;
} // end EEPROM_24LC02B_read_double()
...
} // end EEPROM_24LC02B_write_uint8()
...
} // end EEPROM_24LC02B_write_uint16()
...
} // end EEPROM_24LC02B_write_int16()
...
} // end EEPROM_24LC02B_write_uint32()
...
} // end EEPROM_24LC02B_write_int32()
...
} // end EEPROM_24LC02B_write_float()
...
} // end EEPROM_24LC02B_write_double()
...
void EEPROM_24LC02B_memdump(uint8_t *pData, uint8_t len) {
	...
	while (HAL_I2C_Mem_Read(&EEPROM_24LC02B_I2C_PORT, EEPROM_24LC02B_DEVICE_ADDR, 0, 1, pData, EEPROM_24LC028_MAX_ADDR, 100) != HAL_OK) {
		if (HAL_I2C_GetError(&EEPROM_24LC02B_I2C_PORT) != HAL_I2C_ERROR_AF) {
			Error_Handler();
		}
	}
